...
def main():
    ...
    ckpt_path = config.MODEL_SAVE_DIR / config.CHECKPOINT_UNET

    best_val_iou = 0.0
    grad_accum_steps = 1  # U-Net: standard batch (no accumulation)
    print(f"Starting U-Net training (batch_size={config.BATCH_SIZE}, grad_accum={grad_accum_steps})...")
